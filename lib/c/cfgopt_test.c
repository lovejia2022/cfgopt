...
int main()
{
	...
	struct parser p = new_parser(argv, sizeof(argv) / sizeof(char const *));
	struct cfgopt_result r;

	r = parse(&p, infos, sizeof(infos) / sizeof(struct flag_info));
